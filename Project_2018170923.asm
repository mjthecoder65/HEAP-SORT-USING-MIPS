# Computer architecture, Spring class, 2020
# Michael Jordan(2018170923)
# Final Projects: An implementation of heapsort algorithm 
# Filename: heapsort.asm
...
.data
# the array as a sample data for input of the program
